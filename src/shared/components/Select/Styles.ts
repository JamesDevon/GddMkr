...
export const StyledSelect = styled.div`
  ...
  cursor: pointer;
  ${font.size(14)}
  ${(props: {variant: any, invalid: any, tabIndex: any}) => props.variant === 'empty' && `display: inline-block;`}
  ${(props) =>
...
export const ValueMulti = styled.div`
  ...
  align-items: center;
  flex-wrap: wrap;
  ${(props: { variant: any }) => props.variant === 'normal' && `padding-top: 5px;`}
`;
...
export const Dropdown = styled.div`
  ...
  ${(props: {width: any}) => (props.width ? `width: ${props.width}px;` : 'width: 100%;')}
`;
